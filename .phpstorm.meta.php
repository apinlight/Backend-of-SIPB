...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\KULAIH\ALL_PROJECT\KP_SistemInformasidanPencatatanBarang\backend\public\storage' => 'string',
...
'viewSummary','viewBarang','viewPengajuan','viewCabang','export',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\KULAIH\\ALL_PROJECT\\KP_SistemInformasidanPencatatanBarang\\backend\\public\\storage',
...
'role_or_permission','debug',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','telescope','jenis-barang.index','jenis-barang.store',
'jenis-barang.show','jenis-barang.update','jenis-barang.destroy','users.index','users.store',
'users.show','users.update','users.destroy','batas-barang.index','batas-barang.store',
'batas-barang.show','batas-barang.update','batas-barang.destroy','batas-pengajuan.index','batas-pengajuan.store',
'batas-pengajuan.show','batas-pengajuan.update','batas-pengajuan.destroy',
'docs.index','register','login','password.email','password.update',
'verification.verify','verification.send','storage.local',);
        registerArgumentsSet('views', 
'docs.index','layouts.app','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'DB_USERNAME','DB_PASSWORD','FORCE_HTTPS','BROADCAST_CONNECTION','FILESYSTEM_DISK',
'QUEUE_CONNECTION','CACHE_STORE','CACHE_DB_HOST','CACHE_DB_PORT','CACHE_DB_DATABASE',
'CACHE_DB_USERNAME','CACHE_DB_PASSWORD','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST',
