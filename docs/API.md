...
- `GET /laporan/export-word/summary`: (Admin/Manager) Export laporan ringkasan ke Word (DOCX).
- `GET /laporan/export-word/barang`: (Admin/Manager) Export laporan barang ke Word.
- `GET /laporan/export-word/pengajuan`: (Admin/Manager) Export laporan pengajuan ke Word.
- `GET /laporan/export-word/penggunaan`: (Admin/Manager) Export laporan penggunaan ke Word.
- `GET /laporan/export-word/stok`: (Admin/Manager) Export laporan stok ke Word.
 - `GET /laporan/export-word/all`: (Admin/Manager) Export semua laporan dalam satu file Word terstruktur.
